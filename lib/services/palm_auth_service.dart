...
class PalmAuthService {
  ...
  Future<Map<String, dynamic>> simulateTransaction({
    ...
    final String userId = authResult['user_id'] as String;
    ...
    try {
      await _firestore.runTransaction((transaction) async {
        ...
        double merchantBalance =
            (merchantDoc.data()?['walletBalance'] ?? 0.0).toDouble();
      ...
      return {
        ...
        'message':
            'Successfully charged PKR ${amount.toStringAsFixed(2)} to ${authResult['user_name']}.',
      };
    } catch (e) {
